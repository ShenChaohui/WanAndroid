 ...
 * description: 我的收藏页面
 */
class MyCollectActivity : BaseActivity(), MyCollectContract.IMyCollectView {
    private val presenterImpl by lazy { MyCollectPresenterImpl(this) }
    private var pageNum: Int = 0
    private val adapter by lazy { MyCollectAdapter() }
    ...
    private fun initListener() {
        ...
        adapter.setOnCollectClickListener(object : MyCollectAdapter.OnCollectClickListener {
        ...
        adapter.setOnItemClickListener(object : MyCollectAdapter.OnItemClickListener {
    ...
    override fun unCollectSuccess() {
        ...
        adapter.removeAt(collectPosition)
    }
